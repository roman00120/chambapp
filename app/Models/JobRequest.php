...
class JobRequest extends Model
{
    ...
    protected $fillable = [
        ...
        'requested_date', 'agreed_price', 'economic_model_version', 'base_amount',
        'client_service_fee_percent', 'client_service_fee', 'professional_commission_percent',
        'professional_commission', 'customer_total', 'platform_gross_fee',
        'professional_amount_before_external_costs', 'status', 'accepted_at', 'started_at',
