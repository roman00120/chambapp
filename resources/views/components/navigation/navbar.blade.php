        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="main-navigation"><ul class="navbar-nav ms-auto align-items-md-center gap-md-2">
                @auth
                    ...
                    <li class="nav-item mt-2 mt-md-0"><form method="POST" action="{{ route('logout') }}">@csrf<button class="btn btn-outline-primary w-100 w-md-auto" type="submit">Cerrar sesión</button></form></li>
                @else
                    <li class="nav-item"><a class="nav-link" href="{{ route('marketplace.search') }}">Buscar</a></li>
                    ...
                    <li class="nav-item mt-2 mt-md-0"><a class="btn btn-outline-primary w-100 w-md-auto" href="{{ route('register') }}">Crear cuenta</a></li>
                @endauth
            </ul></div>
        </div>
    </nav>
