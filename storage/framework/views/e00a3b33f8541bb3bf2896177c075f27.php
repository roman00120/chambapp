...
<?php endif; ?>
    ...
    <?php elseif(auth()->user()->isProfessional()): ?>
        ...
        <a class="sidebar-link" href="<?php echo e(route('professional.commerce.featured')); ?>"><i class="bi bi-megaphone" aria-hidden="true"></i> Promocionar</a>
        <a class="sidebar-link" href="<?php echo e(route('professional.commerce.store')); ?>"><i class="bi bi-shop" aria-hidden="true"></i> Tienda de perfil</a>
...
<?php /**PATH C:\Users\Roman\Desktop\chambapp-master\resources\views/components/navigation/sidebar.blade.php ENDPATH**/ ?>