...
<?php endif; ?>
                        ...
                        <div class="d-flex flex-column flex-sm-row gap-2 mb-3">
                            <a class="ui-button ui-button--outline flex-fill" href="<?php echo e(route('auth.google.redirect', ['account_type' => 'client'])); ?>"><i class="bi bi-google" aria-hidden="true"></i> Registrarme como cliente</a>
                            <a class="ui-button ui-button--outline flex-fill" href="<?php echo e(route('auth.google.redirect', ['account_type' => 'professional'])); ?>"><i class="bi bi-google" aria-hidden="true"></i> Registrarme como profesional</a>
                        </div>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Roman\Desktop\chambapp-master\resources\views\auth\register.blade.php ENDPATH**/ ?>