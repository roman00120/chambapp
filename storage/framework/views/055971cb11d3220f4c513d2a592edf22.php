...
<?php endif; ?>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#main-navigation" aria-controls="main-navigation" aria-expanded="false" aria-label="Abrir menú"><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="main-navigation"><ul class="navbar-nav ms-auto align-items-md-center gap-md-2">
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <li class="nav-item mt-2 mt-md-0"><form method="POST" action="<?php echo e(route('logout')); ?>"><?php echo csrf_field(); ?><button class="btn btn-outline-primary w-100 w-md-auto" type="submit">Cerrar sesión</button></form></li>
                <?php else: ?>
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('marketplace.search')); ?>">Buscar</a></li>
                    ...
                    <li class="nav-item mt-2 mt-md-0"><a class="btn btn-outline-primary w-100 w-md-auto" href="<?php echo e(route('register')); ?>">Crear cuenta</a></li>
                <?php endif; ?>
            </ul></div>
        </div>
    </nav>
</header>
<?php /**PATH C:\Users\USER\Desktop\chambapp\resources\views/components/navigation/navbar.blade.php ENDPATH**/ ?>