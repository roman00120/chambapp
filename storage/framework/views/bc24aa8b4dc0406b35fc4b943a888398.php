...
<?php $component->withAttributes(['padding' => 'lg']); ?><form method="POST" action="<?php echo e(route('client.scheduled.store')); ?>"><?php echo csrf_field(); ?>
    <div class="mb-3"><label class="form-label" for="scheduled-mode">Tipo de solicitud</label><select class="form-select" id="scheduled-mode" name="service_mode" required><option value="scheduled" <?php if(old('service_mode', 'scheduled') === 'scheduled'): echo 'selected'; endif; ?>>Servicio programado</option><option value="diagnostic" <?php if(old('service_mode') === 'diagnostic'): echo 'selected'; endif; ?>>Cita de diagnóstico</option></select><div class="form-text">El diagnóstico permite revisar tu necesidad antes de definir el trabajo.</div></div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Roman\Desktop\chambapp-master\resources\views\client\scheduled\create.blade.php ENDPATH**/ ?>